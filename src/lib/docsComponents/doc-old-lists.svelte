...
<p>Just go to the <a href="/new">Manage page</a> page and if you have lists to migrate, they will automatically appear there under the title '🔺 List in old format'.</p>
<hr/>
<p>There you will have a couple of buttons, <RepublishIcon size={18}/> to migrate the list to the new format and <BinIcon size={18}/> if you want to get rid of the list.</p>
</div>