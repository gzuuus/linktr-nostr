...
<h2>Share Slug</h2>
<h3>Share Slug is a simple way to share your nostree lists under a specific slug.</h3>
...
<p>> <ShareIcon size={18}/> This will open a dialog menu to share the slug (only available on mobile).</p>
