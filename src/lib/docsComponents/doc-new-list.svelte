...
<ul>
  ...
  <li><strong>Links</strong>: with two fields, one for the URL and one for the description of this URL</li>
  <li><strong>Slug</strong>: This allows you to have a memorable way to share your list. It's not obligatory; if you leave it blank, it will be automatically generated</li>
</ul>
<hr>
<h4>Form Buttons</h4>
