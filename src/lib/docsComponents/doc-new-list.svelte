...
<div class="DocsContentContainer">
  ...
  <p>In the fields of the form, you can find:</p>
  <ul>
    <li><strong>Title</strong>: to name your list</li>
    <li>
      <strong>Links</strong>: with two fields, one for the URL and one for the description of this URL
    </li>
    <li>
      <strong>Slug</strong>: This allows you to have a memorable way to share your list. It's not obligatory; if you
      leave it blank, it will be automatically generated
    </li>
  </ul>
  <hr />
  <h4>Form Buttons</h4>
  <p>
    The buttons are <PlusSmall size={18} /> to add more link fields, 'Publish' to publish your list, and <ResetIcon
      size={18}
    />, to reset the list form
  </p>
  <hr />
