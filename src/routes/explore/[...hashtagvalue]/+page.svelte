 <script lang="ts">
  ...
  import { unixToDate, findOtherTags, naddrEncodeATags, processHashtags, filterDbEvents } from "$lib/utils/helpers";
...
<!-- {#if exploreCachedResults}
  {#each exploreCachedResults as event}
